                ...
                <div class="card card-info">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <a href="{{ route('admin.agent.create') }}" class="btn btn-sm btn-primary">
                    ...
                    <div class="card-body p-0">
                        <table class="table table-striped table-hover">
                            <thead>
                                <tr>
                                    {{-- Replaced '#' with a static '+' icon column header --}}
                                    <th style="width: 10px;">
                                       #
                                    </th>
                                    {{-- The dropdown column --}}
                                    <th style="width: 10px;">
                                        <button class="btn btn-xs btn-primary dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="fas fa-caret-down"></i> {{-- Changed from plus to caret-down --}}
                                        </button>
                            ...
                            <tbody>
                                {{-- Static Agent Row based on image_3171c2.png --}}
                                <tr>
                                    {{-- Plus icon for each row to open the modal --}}
                                    <td>
